...
import table from '../../assets/adam_table.svg'
import circle from '../../assets/subwoofer_circles.svg'
import base from '../../assets/subwoofer_base.svg'
...
export default connect(
	(state) => ({
		drawerIsOpen: state.home.drawerOpen,
